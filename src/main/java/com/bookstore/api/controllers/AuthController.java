...
import com.bookstore.api.entities.dto.request.RefreshDto;
import com.bookstore.api.entities.dto.request.UserRequest;
...
public class AuthController {
    ...
    public AuthController(AuthenticationManager authenticationManager, JwtTokenProvider jwtTokenProvider,
			UserService userService, RefreshTokenServiceImp refreshTokenService, ModelMapper mapper) {
		super();
    ...
    public ResponseEntity<AuthDto> register(@RequestBody UserRequestForRegister registerRequest) {
        ...
        // User creating...
        User user = new User();
        mapper.map(registerRequest, User.class);
