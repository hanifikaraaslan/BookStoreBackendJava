package com.bookstore.api.utilities;
...
import com.bookstore.api.utilities.abstracts.AuthenticationService;

import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
@Service
public class AuthenticationControl implements AuthenticationService {
	 ...
	 private AuthenticationManager authenticationManager;
	    ...
	    public AuthDto login(UserRequest loginRequest) {
		...
		@Override
		public ResponseEntity<AuthDto> register(UserRequestForRegister registerRequest) {
		       AuthDto authResponse = new AuthDto();
		...
		@Override
		public ResponseEntity<?> refresh(RefreshDto refreshRequest) {
